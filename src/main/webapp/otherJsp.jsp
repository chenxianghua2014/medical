...
.sec h3{width:170px;height:30px;background:#C6E2FF;}
       ...
       <div class="c_left">
        	<div class="zymu"><img src="info_show_js/images/zyml.gif" />资源目录</div>
            	...
            	<ul>
									...
									<li><a href="newsinfo/key_Tecl_1/8.doc"><span>胆道结石-基线</span></a></li>
									<li><a href="newsinfo/key_Tecl_1/9.doc"><span>胆道结石观察表</span></a></li>
                                 	</ul>
