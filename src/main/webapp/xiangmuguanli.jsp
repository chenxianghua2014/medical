	...
	<body>
		<div id="wrapper" align="center">
			...
			<div id="page">
			   ...
			   <td width="30"></td>
				...
				<a href=""><img src="fimages/shujuwajue.jpg"> </a><a
										href=""></a>
									<h2>
										<a href="guanjianjishuyufuwu.jsp" style="text-decoration:none "><strong>数据服务</strong></a>
									</h2>
				</td>
				</tr>
				</table>
				...
				<a href="peixun/video.jsp"><img src="fimages/peixun.jpg" /> </a>
									<h2>
										<a href="peixun/video.jsp" style="text-decoration:none "><strong>远程培训</strong></a>
									</h2>
				</td>
				</tr>
			...
			<a><img src="fimages/xinxi.jpg"></a>
									<h2>
										<a href="index.jsp" style="text-decoration:none "><strong>信息发布</strong> </a>
									</h2>
				</td>
				</tr>
				</table>
